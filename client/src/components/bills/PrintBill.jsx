...
const PrintBill = ({ isModalOpen, setIsModalOpen, customer }) => {
  ...
  return (
    < Modal
      ...
      width={800}
    >
      <section className="py-10 bg-red-700 rounded-3xl" ref={componentRef}>
        <div className="max-w-5xl mx-auto bg-white px-6">
          <article className="overflow-hidden">
            <div className="logo my-6">
              <h2 className="text-4xl font-bold text-slate-700"><img width={75} src="images/logo.png" alt="" /></h2>
            </div>
            <div className="bill-details">
              <div className="grid sm:grid-cols-4 grid-cols-3 gap-12">
                <div className="text-md text-slate-500">
                  <p className="font-bold text-slate-700">Fatura Detayı:</p>
                  <b className="text-red-700">{customer?.customerName}</b>
      ...
      <div className="flex justify-end mt-4">
        <button type="danger" size="large" className="bg-red-700 text-white hover:bg-black p-2 rounded-xl"  onClick={handlePrint}>
          Yazdır
        </button>
      </div>
    </ Modal>
